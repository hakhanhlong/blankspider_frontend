...
/******/([
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        function configure(PDFJS) {
            ...
            PDFJS.workerSrc = '../../../static/scripts/pdf.worker.js';
                ...
                updateUIState: function PDFFindBar_updateUIState(state, previous, matchCount) {
                    ...
                    switch (state) {
                        ...
                        case FindStates.FIND_NOTFOUND:
                            findMsg = mozL10n.get('find_not_found', null, 'Không tìm thấy từ khóa phù hợp');
                            notFound = true;
                            break;
                        case FindStates.FIND_WRAPPED:
                            if (previous) {
                                findMsg = mozL10n.get('find_reached_top', null, 'Đã đến từ khóa ở đầu danh sách tìm kiếm, tiếp tục từ dưới lên');
                            } else {
                                findMsg = mozL10n.get('find_reached_bottom', null, 'Đã đến từ khóa ở cuối danh sách , tiếp tục từ trên xuống');
                            }
                            break;
                    }
                    if (notFound) {
    ...
    /***/ (function (module, exports, __webpack_require__) {
        ...
        function getViewerConfiguration() {
            return {
                ...
                defaultUrl: document.getElementById('pdf_url').textContent
            };
        }
