...
class Development(Config):
    ...
    MONGO_DATABASE_SECURITY_SERVER = os.environ.get('DEV_DATABASE_SERVER') or '118.107.88.119'
    ...
    MONGO_DATABASE_BLANKSPIDER_SERVER = os.environ.get('DEV_DATABASE_SERVER') or '118.107.88.119'
    ...
    MONGO_DATABASE_ARCHIVIED_SERVER = os.environ.get('DEV_DATABASE_SERVER') or '118.107.88.119'
    MONGO_DATABASE_ARCHIVIED_PORT = os.environ.get('DEV_DATABASE_PORT') or 27017
    MONGO_DATABASE_ARCHIVIED_NAME = os.environ.get('DEV_DATABASE_NAME') or 'lcbc_content_archived'
